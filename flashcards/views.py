                ...
                if flashcards_data:
                    ...
                    if use_visual_regions:
                        ...
                        for idx, card_data in enumerate(flashcards_data):
                            ...
                            # Increased threshold to 0.45 (45%) to ensure highly accurate/relevant images
                            if matched_region and matched_region.image and confidence >= 0.45 and confidence != 0.5:
                                try:
